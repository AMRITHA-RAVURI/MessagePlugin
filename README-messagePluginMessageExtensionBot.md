# MessagePlugin Message Extension Bot - `messagePluginMessageExtensionBot`
...
3. Give the bot a handle (ex: `messagePluginMessageExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://messagingplugin.azurewebsites.net/api/messages`
